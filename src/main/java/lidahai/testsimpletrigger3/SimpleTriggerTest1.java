...
public class SimpleTriggerTest1 {
	public static void main(String[] args) throws SchedulerException {
		...
		JobDetail jobDetail = JobBuilder.newJob(MyJobDetail1.class).withIdentity("job1", "group1").usingJobData("name", "xiaogao").build();
		...
		jobDetail = JobBuilder.newJob(MyJobDetail1.class).withIdentity("job2", "group2").usingJobData("name", "xiaoming").build();
